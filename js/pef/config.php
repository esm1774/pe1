...
define('DB_NAME', 'u402628076_pe_smart_sch');     // اسم قاعدة البيانات - غيّره حسب استضافتك
define('DB_USER', 'u402628076_pe_smart_sch');               // اسم المستخدم - غيّره حسب استضافتك  
define('DB_PASS', 'EsmM@1974');                   // كلمة المرور - غيّرها حسب استضافتك
