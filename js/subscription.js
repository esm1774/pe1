    ...
    <div class="fade-in max-w-5xl mx-auto px-4 md:px-0">
        ...
        return `
                        ...
                        <div class="flex flex-wrap gap-4">
                            <button class="bg-emerald-500 hover:bg-emerald-400 text-white px-10 py-4 rounded-2xl font-black transition shadow-xl shadow-emerald-500/20 active:scale-95 leading-none">ترقية الخطة</button>
                            ${s.notes ? `
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-[2.5rem] p-8 shadow-xl shadow-gray-100/50 border border-gray-50">
                    ...
                    <button class="w-full bg-gray-900 text-white py-4 rounded-2xl font-black text-sm hover:bg-black transition">تواصل مع المبيعات</button>
                </div>
            </div>
        </div>
    </div>`;
